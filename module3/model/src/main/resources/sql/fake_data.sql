...
BEGIN
    ...
    WHILE
        i <= 10000
        DO
            INSERT INTO certificates(id, name, description, price, duration, create_date, last_update_date, status)
                VALUE (i, CONCAT('Certificate', i), CONCAT('This is ', i, ' certificate description'),
                       ROUND(RAND() * 99.99 + 0.01, 2), FLOOR(RAND() * (366 + 4)), NOW(), NOW(), 'ACTIVE');
            SET
                i = i + 1;
        END WHILE;
END;
        ...
        DO
            ...
            WHILE
                ...
                DO
                    ...
                    INSERT
                        IGNORE
                    INTO gift_certificate_tag(tag_id, gift_certificate_id)
                        VALUE (t_id, c_id);
                    SET
                        tQty = tQty - 1;
                END WHILE;
        ...
        DO
            ...
            WHILE
                ...
                DO
                    ...
                    INSERT
                        IGNORE
                    INTO user_order_gift_certificate(user_order_id, gift_certificate_id)
                        VALUE (uo_id, c_id);
                    SET
                        cQty = cQty - 1;
                END WHILE;
